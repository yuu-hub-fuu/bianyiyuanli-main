...
class NexaStudio(tk.Tk):
    ...
    def _highlight_source(self) -> None:
        ...
        patterns = [
            ...
            ("keyword", r"\b(import|pub|fn|let|return|if|else|while|for|in|break|continue|struct|enum|match|macro|spawn|select|recv|send|default|true|false)\b", re.MULTILINE),
    ...
    def compile_now(self, run: bool = False, trace: bool = False) -> None:
        ...
        res = compile_source(source, mode=self.mode.get(), export_dir="out", run=run, trace=trace)
